...
import styles from './GraphAreaSpeedSurfaceHeight.module.scss'
...
export const GraphAreaSpeedSurfaceHeight = (props: propsGraphSpeedHeight) => {
        ...
        <div className={styles.main}>
            ...
            <ResponsiveContainer width="100%" height={720}>
                ...
                >
                    ...
                    <defs> 
                        <linearGradient id={"color-surface"} x1="0" y1="0" x2="100%" y2="0">
                            {data.map((p, i) => {

                                return (
                                    <stop 
                                        offset={`${100 / data.length * i + 100 / data.length}%`} 
                                        stopColor={p.surface === Surface.ASPHALT
                                            ? "gray"
